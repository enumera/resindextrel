...
class ChecklistItemsControllerTest < ActionController::TestCase
  ...
  test "should create checklist_item" do
    assert_difference('ChecklistItem.count') do
      post :create, checklist_item: { checklist_id: @checklist_item.checklist_id, completed: @checklist_item.completed, name: @checklist_item.name }
    end
  ...
  test "should update checklist_item" do
    put :update, id: @checklist_item, checklist_item: { checklist_id: @checklist_item.checklist_id, completed: @checklist_item.completed, name: @checklist_item.name }
    assert_redirected_to checklist_item_path(assigns(:checklist_item))
  end
