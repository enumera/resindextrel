...
class TimeRecordsControllerTest < ActionController::TestCase
  ...
  test "should create time_record" do
    assert_difference('TimeRecord.count') do
      post :create, time_record: { task_id: @time_record.task_id, timerecord: @time_record.timerecord, user_id: @time_record.user_id }
    end
  ...
  test "should update time_record" do
    put :update, id: @time_record, time_record: { task_id: @time_record.task_id, timerecord: @time_record.timerecord, user_id: @time_record.user_id }
    assert_redirected_to time_record_path(assigns(:time_record))
  end
